...
namespace Quiz_Application
{
    public partial class Quiz_Form : Form
    {
        ...
        // Inisialisasi agar tidak null saat keluar constructor
        private int[] userAnswers = Array.Empty<int>();
    ...
    {
        // Beri nilai default agar tidak null
        public string Text { get; set; } = string.Empty;

        // Inisialisasi array kosong agar tidak null
